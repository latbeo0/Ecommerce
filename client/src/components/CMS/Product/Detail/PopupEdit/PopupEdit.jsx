...
const PopupEdit = ({ open, master, row, onClose, onSubmit }) => {
    ...
    const handleChangeColor = (e) => {
        ...
        setProductData({
            ...product,
            color: { ...product.color, [name]: value },
        });
    };
    ...
    const handleCloseImage = (e, index, type) => {
        ...
        switch (type.toUpperCase()) {
            case "PRIMARYIMAGES":
                ...
                setProductData({
                    ...product,
                    primaryImages: [...ftempArr, ...ltempArr],
                });
                break;
            case "SECONDARYIMAGES":
                ...
                setProductData({
                    ...product,
                    secondaryImages: [...ftempArr, ...ltempArr],
                });
                break;
            default:
                break;
            ...
            await fetchAddNewProduct(
                ...
                .then((response) => {
                    if (response.status === 200) {
                        ...
                        Notification(NotificationType.error, response.data.msg);
                })
            ...
            <DialogContent>
                ...
                <MuiGrid container spacing={2}>
                    ...
                    >
                        ...
                        <Link
                            id="addItem"
                            onClick={(e) => handleCalCColorDetail(e)}
                        >
                            New Size
                        </Link>
